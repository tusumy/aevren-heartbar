...
assert.match(html,/\.bar::after\{[^}]*border-radius:23px 17px 24px 18px/,"outer shell carries the irregular liquid membrane");
assert.doesNotMatch(html,/\.goo::after\{/,"edge decoration does not grow a separate slime blob");
