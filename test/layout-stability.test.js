...
assert.match(html,/clip-path:url\(#whale-card-clip\)/,"the entire card is clipped to the animal silhouette");
...
assert.match(html,/id="whale-card-clip" clipPathUnits="objectBoundingBox"/,"animal silhouette scales with the card");
assert.match(html,/class="whale-eye"/,"abstract whale profile keeps one restrained eye detail");
assert.doesNotMatch(html,/class="dragon-/,"literal dragon decoration is removed");
assert.match(html,/padding:17px 20px 17px 38px/,"left content clears the whale head curve");
