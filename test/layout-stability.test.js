...
assert.match(html,/class="dragon-head"/,"left edge is shaped as a dragon head");
assert.match(html,/class="dragon-eye"/,"dragon head keeps a restrained jade eye");
assert.match(html,/class="frame-spike"/,"right edge ends in a pointed crystal tail");
assert.match(html,/padding:17px 20px 17px 38px/,"left content clears the dragon head");
