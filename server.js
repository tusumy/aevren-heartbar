...
const currentWidgetUri = "ui://aevren/heartbar-v13.html";
const widgetUris = ["ui://aevren/heartbar-v1.html", "ui://aevren/heartbar-v2.html", "ui://aevren/heartbar-v3.html", "ui://aevren/heartbar-v4.html", "ui://aevren/heartbar-v5.html", "ui://aevren/heartbar-v6.html", "ui://aevren/heartbar-v7.html", "ui://aevren/heartbar-v8.html", "ui://aevren/heartbar-v9.html", "ui://aevren/heartbar-v10.html", "ui://aevren/heartbar-v11.html", "ui://aevren/heartbar-v12.html", currentWidgetUri];

const clamp = (value, min, max) => Math.max(min, Math.min(max, value));

function makeServer() {
  const server = new McpServer(
    { name: "aevren-heartbar", version: "2.1.5" },
    {
      instructions:
...
app.get("/health", (_req, res) => {
  res.json({ ok: true, name: "aevren-heartbar", version: "2.1.5" });
});
